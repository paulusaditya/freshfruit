    ...
    <section class="ftco-section ftco-no-pb ftco-no-pt bg-light">
			<div class="container">
	          ...
	          <div class="heading-section-bold mb-4 mt-md-5">
	          	<div class="ml-md-0">
		            <h2 class="mb-4">Welcome to Fresh Fruit an eCommerce website</h2>
	            </div>
	          </div>
	          <div class="pb-md-5">
              <p>Fresh Fruit adalah situs web yang khusus menyediakan informasi lengkap mengenai produk buah-buahan yang dijual dan tersedia di toko kami. Di sini, Anda dapat menemukan berbagai jenis buah-buahan segar berkualitas tinggi yang bernutrisi dan mendukung gaya hidup sehat Anda.</p>
        ...
        <div class="row ftco-animate">
          <div class="col-md-12">
            <div class="carousel-testimony owl-carousel">
              ...
              <div class="item">
                <div class="testimony-wrap p-4 pb-5">
                  <div class="user-img mb-5" style="background-image: url(images/team/desainer.jpeg)">
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
                    </span>
                  </div>
